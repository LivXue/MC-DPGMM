...
class Loss(nn.Module):
    def __init__(self, batch_size, temperature_f, temperature_c, temperature_s):
    ...
    def contrastive_loss(self, view1_feature, view2_feature, t=0.21):
        ...
        sim_view12 = self.similarity(view1_feature.unsqueeze(1), view2_feature.unsqueeze(0)) / self.temperature_s
